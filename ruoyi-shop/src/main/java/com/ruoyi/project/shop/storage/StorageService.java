package com.ruoyi.project.shop.storage;


import com.ruoyi.common.utils.CharUtil;
import com.ruoyi.project.shop.domain.LitemallStorage;
import com.ruoyi.project.shop.service.impl.LitemallStorageServiceImpl;
...
public class StorageService {
    ...
    @Autowired
    private LitemallStorageServiceImpl litemallStorageService;
    ...
    public LitemallStorage store(InputStream inputStream, long contentLength, String contentType, String fileName) {
        ...
        litemallStorageService.insertLitemallStorage(storageInfo);
    ...
    private String generateKey(String originalFilename) {
        ...
        do {
            ...
            storageInfo = litemallStorageService.selectLitemallStorageByKey(litemallStorage);
        }
