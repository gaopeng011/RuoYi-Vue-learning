<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-hasPermi="['shop:couponUser:list']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
    </div>
...
<script>
import { readCoupon, listCouponUser } from "@/api/shop/coupon";
