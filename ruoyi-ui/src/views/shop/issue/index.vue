<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="issueList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="问题标题" align="center" prop="question" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="问题答案" prop="answer">
          <el-input v-model="form.answer" placeholder="请输入问题答案" />
        </el-form-item>
      </el-form>
...
<script>
import { listIssue, getIssue, delIssue, addIssue, updateIssue, exportIssue } from "@/api/shop/issue";
