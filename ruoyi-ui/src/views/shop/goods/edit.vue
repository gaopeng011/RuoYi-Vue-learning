  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="specifications">
        ...
        <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-edit" size="mini" @click="handleSpecificationShow(scope.row)">设置</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-edit" size="mini" @click="handleProductShow(scope.row)">设置</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="attributesData">
        ...
        <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-edit" size="mini" @click="handleAttributeShow(scope.row)">设置</el-button>
            <el-button type="text" icon="el-icon-delete" size="mini" @click="handleAttributeDelete(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { detailGoods, editGoods, listCatAndBrand } from '@/api/shop/goods'
  ...
  methods: {
    init: function() {
      ...
      detailGoods(goodsId).then(response => {
        ...
        console.log(response.data.goods.detail)
        // 稍微调整一下前后端不一致
        ...
        //   let str=this.goods.detail;
        //
        //   this.goods.detail=str.replace("\"\\\\","\"");
        // }
    ...
    handleEdit: function() {
      ...
      editGoods(JSON.stringify(finalGoods))
        .then(response => {
          this.$notify.success({
            title: '成功',
            message: '创建成功'
        ...
        .catch(response => {
          MessageBox.alert('业务错误：' + response.msg, '警告', {
