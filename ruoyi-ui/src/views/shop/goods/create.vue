  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="specifications">
        ...
        >
          <template slot-scope="scope">
            <el-button type="text" icon="el-icon-delete" size="mini" @click="handleSpecificationDelete(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { listGoods,publishGoods, listCatAndBrand } from '@/api/shop/goods'
...
export default {
  ...
  data() {
    return {
      ...
      categoryList: [],
      brandList: [],
      goods: { goodsSn: '', name: '',counterPrice: '',picUrl: '', gallery: [], isHot: 0, isNew: 1, isOnSale: 1 },
      specVisiable: false,
  ...
  methods: {
    ...
    reset() {
      ...
      this.resetForm("specifications");
      this.resetForm("productForm");
      this.resetForm("products");
