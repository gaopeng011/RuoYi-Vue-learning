<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="商品规格名称" prop="specification">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['shop:specification:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['shop:specification:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shop:specification:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:specification:export']"
        >导出</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="specificationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品规格名称" align="center" prop="specification" />
      <el-table-column label="商品规格值" align="center" prop="value" />
      <el-table-column label="商品规格图片" align="center" prop="picUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品规格名称" prop="specification">
          <el-input v-model="form.specification" placeholder="请输入商品规格名称" />
        </el-form-item>
        <el-form-item label="商品规格值" prop="value">
          <el-input v-model="form.value" placeholder="请输入商品规格值" />
        </el-form-item>
        <el-form-item label="商品规格图片" prop="picUrl">
          <el-input v-model="form.picUrl" placeholder="请输入商品规格图片" />
        </el-form-item>
        <el-form-item label="创建时间" prop="addTime">
          <el-date-picker clearable size="small" style="width: 200px"
...
<script>
import { listSpecification, getSpecification, delSpecification, addSpecification, updateSpecification, exportSpecification } from "@/api/shop/specification";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        value: [
          { required: true, message: "商品规格值不能为空", trigger: "blur" }
        ],
        picUrl: [
          { required: true, message: "商品规格图片不能为空", trigger: "blur" }
        ],
      }
    };
  },
